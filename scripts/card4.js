document.getElementById('btn-emoji').addEventListener('click',function(event){
...
document.getElementById('btn-emoji').addEventListener('click',function(event){
  ...
  document.getElementById('btn-emoji').addEventListener('click',function(event){
   ...
   let time = new
        ...
        let result = 'You have complete the taks  ' +  'Add new emoji 🤲 '  + 'at'+ time;
        ...
        document.getElementById('transection-container').style.gap = '10px';
